					...
					<div class="radio radio-primary">
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="email" id="email"   pattern="^[a-zA-Z0-9.!#$%&'*+=?^_`{|}~-]+@[a-zA-Z]+(\.[a-zA-Z0-9-]+)+$" placeholder="Enter your Email"/>
								</div>
							</div>
						</div>
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control" id="dept">
                            ...
                            <option>Medicine Specialists</option>
                            <option>skin</option>
