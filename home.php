...
?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input id="name" e name="p_name" type="text" placeholder="Name" required class="form-control input-md"> </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label" for="email">Email</label>
                                                    <input id="email" name="email" type="text" placeholder="E-Mail" required class="form-control input-md"> </div>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label" for="date">Preferred Date</label>
                                                    <input id="date" name="date" type="date" placeholder="Preferred Date" required class="form-control input-md"> </div>
                                            </div>
                                            <!-- Select Basic -->
                                            <div class="col-md-6">
                                                <div class="form-group">
	 ...
	 while($result=mysqli_fetch_assoc($result1)){ 
		 $count++;
											...
											?>
                                                            <option value="<?php echo($result['d_id']);?>">
			  ...
			  ?>
				...
				$result4 = mysqli_fetch_assoc($result3);
				 ?>
                                        ...
                                        <td>
                                            <?php echo($result['problem'])?>
                                        </td>
                                        <td>
                                            <?php if($result['status']==0){echo('pending');}else{echo('Accepted');}?>
                                        </td>
