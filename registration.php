						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="p_name" id="name"  placeholder="Enter your Name" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" required/>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="cols-sm-10">
								<div class="input-group">
									...
									<input required type="text" class="form-control" name="email" id="email"   pattern="^[a-zA-Z0-9.!#$%&'*+=?^_`{|}~-]+@[a-zA-Z]+(\.[a-zA-Z0-9-]+)+$" placeholder="Enter your Email"/>
								</div>
							</div>
						</div>
